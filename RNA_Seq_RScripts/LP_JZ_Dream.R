...
rownames(Sample_Info) = Sample_Info$Sample_ID_JZ
Sample_Info = Sample_Info %>% filter(Strain == "BW" | Strain == "ME")

# Read in Files + QC
Pman_rawreads = read_xlsx("RNA_Seq_RawData/LP_JZ_Pman_ExtMMFrac_readcounts_Exon.xlsx")
...
# Write Out
write.csv(final, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_dreamISO_Contrasts.csv")
write.csv(DE_strain, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_dreamISO_strainDE.csv")
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_dreamISO_o2DE.csv")
write.csv(DE_ixn, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_dreamISO_ixnDE.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_BW_dreamISO_o2DE.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/LP_JZ_ME_dreamISO_o2DE.csv")
