...
EP_ISO_Strain = read_csv("Test_Dream_RawFiles/EP_dreamISO_strainDE_test.csv")
...
EP_ISO_O2 = read_csv("Test_Dream_RawFiles/EP_dreamISO_o2DE_test.csv")
...
EP_ISO_IXN = read_csv("Test_Dream_RawFiles/EP_dreamISO_ixnDE_test.csv")
...
EP_ISO_BW = read_csv("Test_Dream_RawFiles/EP_BW_dreamISO_o2DE_test.csv")
...
EP_ISO_ME = read_csv("Test_Dream_RawFiles/EP_ME_dreamISO_o2DE_test.csv")
...
EP_ISO_Summary = left_join(EP_ISO_5, Apriori, by = "Gene_ID") %>% 
 ...
 write.csv(EP_ISO_Summary, "Test_Dream_RawFiles/EP_ISO_Summary_test.csv")
...
LP_ISO_Strain = read_csv("Test_Dream_RawFiles/LP_dreamISO_strainDE.csv")
...
LP_ISO_O2 = read_csv("Test_Dream_RawFiles/LP_dreamISO_o2DE.csv")
...
LP_ISO_IXN = read_csv("Test_Dream_RawFiles/LP_dreamISO_ixnDE.csv")
...
LP_ISO_BW = read_csv("Test_Dream_RawFiles/LP_BW_dreamISO_o2DE.csv")
...
LP_ISO_ME = read_csv("Test_Dream_RawFiles/LP_ME_dreamISO_o2DE.csv")
...
write.csv(LP_ISO_Summary, "Test_Dream_RawFiles/LP_ISO_Summary_test.csv")
