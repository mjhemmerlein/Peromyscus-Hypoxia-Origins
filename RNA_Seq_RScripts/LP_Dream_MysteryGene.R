...
# Write Out
write.csv(final, "Test_Dream_RawFiles/LP_dreamISO_Contrasts.csv")
write.csv(DE_strain, "Test_Dream_RawFiles/LP_dreamISO_strainDE.csv")
write.csv(DE_o2, "Test_Dream_RawFiles/LP_dreamISO_o2DE.csv")
write.csv(DE_ixn, "Test_Dream_RawFiles/LP_dreamISO_ixnDE.csv")
...
# Write Out
write.csv(DE_o2, "Test_Dream_RawFiles/LP_BW_dreamISO_o2DE.csv")
...
# Write Out
write.csv(DE_o2, "Test_Dream_RawFiles/LP_ME_dreamISO_o2DE.csv")
