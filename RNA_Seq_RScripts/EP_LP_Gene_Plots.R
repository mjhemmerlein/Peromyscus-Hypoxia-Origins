...
dPman <- dPman_0[keep,]
dim(dPman)
plotMDS(dPman, col = as.numeric(LP_Sample_Info$Strain), labels = LP_Sample_Info$Strain)

rownames(LP_Sample_Info) == colnames(dPman)
...
plot_gene_expression_faceted("Ndufb10", "Ndufb10", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
...
plot_gene_expression_faceted("C5H7orf25", "C5H7orf25", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Etfa", "Etfa", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Mtfmt", "Mtfmt", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("LOC102928132", "Zfp58", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Pmpcb", "Pmpcb", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Clp1", "Clp1", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Ppp1ca", "Ppp1ca", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
...
plot_gene_expression_faceted("LOC102910403", "Arf2", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Tmem9b", "Tmem9b", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Creb3", "Creb3", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Tmco1", "Tmco1", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Ykt6", "Ykt6", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("Rnf5", "Rnf5", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
plot_gene_expression_faceted("U2af1l4", "U2af1l4", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
...
# For saving:
 ...
 save_faceted_plot("Nnat", "Nnat", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Slc34a2", "Slc34a2", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Vps45", "Vps45", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Etfa", "Etfa", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Creb3", "Creb3", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Slc22a3", "Slc22a3", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
 save_faceted_plot("Cacna1s", "Cacna1s", EP_vobjDream, LP_vobjDream, EP_Sample_Info, LP_Sample_Info)
