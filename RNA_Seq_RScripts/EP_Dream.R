...
# Write Out
write.csv(final, "RNA_Seq_Output/Dream_RawFiles/EP_dreamISO_Contrasts.csv")
write.csv(DE_strain, "RNA_Seq_Output/Dream_RawFiles/EP_dreamISO_strainDE.csv")
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_dreamISO_o2DE.csv")
write.csv(DE_ixn, "RNA_Seq_Output/Dream_RawFiles/EP_dreamISO_ixnDE.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_BW_dreamISO_o2DE.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_ME_dreamISO_o2DE.csv")
