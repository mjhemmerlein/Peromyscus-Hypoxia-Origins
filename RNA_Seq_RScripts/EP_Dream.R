...
# Write Out
write.csv(final, "RNA_Seq_Output/Dream_RawFiles/EP_dreamGCF_Contrasts.csv")
write.csv(DE_strain, "RNA_Seq_Output/Dream_RawFiles/EP_dreamGCF_strainDE.csv")
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_dreamGCF_o2DE.csv")
write.csv(DE_ixn, "RNA_Seq_Output/Dream_RawFiles/EP_dreamGCF_ixnDE.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_BW_dreamGCF_o2DE_background.csv")
...
# Write Out
write.csv(DE_o2, "RNA_Seq_Output/Dream_RawFiles/EP_ME_dreamGCF_o2DE_background.csv")
